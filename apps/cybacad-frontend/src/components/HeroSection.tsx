...
// If this file doesn't exist yet, comment this import out to pass the build:
...
export const HeroSection = () => {
  ...
  const handleRoleClick = (role: string) => {
    // logRoleSelection(role); // Uncomment when analytics service exists
  ...
  return (
    // ✅ CHANGED: bg-gradient-to-br -> bg-linear-to-br (Tailwind v4)
    <section className="bg-linear-to-br from-blue-50 to-white py-16 px-6 text-center md:text-left md:flex md:items-center md:justify-between overflow-hidden">
      <motion.div
        className="max-w-xl"
        initial="hidden"
        animate="visible"
